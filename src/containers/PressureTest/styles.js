...
const styles = StyleSheet.create({
    ...
    rowHeader: { flexDirection: "row", paddingVertical: 10, paddingLeft: 10 },
    rowData: { flexDirection: "row", paddingVertical: 10, borderTopWidth: 1, borderColor: "lightgrey", paddingLeft: 10 },
    nameView: { flex: 0.25, justifyContent: 'center', },
    reportView: { flex: 0.3, justifyContent: 'center', },
